		...
		<>
			...
			<footer className={classes.footer}>
                <div className={classes.footerTop}>
					<li className={classes.footerTopMenuItem}>خانه</li>
					<li className={classes.footerTopMenuItem}>گالری</li>
					<li className={classes.footerTopMenuItem}>فیلم</li>
					<li className={classes.footerTopMenuItem}>اخبار</li>
