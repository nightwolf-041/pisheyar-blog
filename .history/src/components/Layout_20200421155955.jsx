...
import { faSearch, faLocationArrow, faPhoneAlt } from "@fortawesome/free-solid-svg-icons";
			...
			<footer className={classes.footer}>
				...
				<div className={classes.footerMiddleBox}>
					...
					<div className={classes.footerMiddleLeft}>
						<div className={footerMiddleLeftSection}>
							<FontAwesomeIcon icon={faPhoneAlt}
								className={classes.footerMiddleLeftPhoneIcon} />
