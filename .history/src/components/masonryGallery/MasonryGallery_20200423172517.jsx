...
const MasonryGallery = () => {
    ...
    const slicePosts = () => {
        setCurrentPage(2)
        posts.slice((currentPage - 1) * pagesIndex, currentPage * pagesIndex);
    }
    ...
    return(
        ...
        >
            {posts.slice((currentPage - 1) * pagesIndex, currentPage * pagesIndex).map((post, index) => (
        ...
        />
        <button onClick={slicePosts}>slice</button>
        </>
    )
}
