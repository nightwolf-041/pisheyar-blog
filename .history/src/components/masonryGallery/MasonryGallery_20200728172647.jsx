  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        for (let i in posts) {
          console.log(res.data.posts[i].title);
        }
      })
      .catch((err) => {});
  }, []);
    ...
    <>
      ...
      <div className={classes.masonryGalleryPaginationBox}>
        ...
        <div className={classes.masonryPaginationJumpBox}>
          <input
            type="text"
            className={classes.masonryPaginationJumpInput}
            placeholder="برو به"
            onChange={(e) => paginationJumpChange(e)}
          />
          <div
            className={classes.masonryPaginationJumpIconBox}
            onClick={paginationJumpHandler}
          >
            <FontAwesomeIcon
              icon={faCaretSquareRight}
              className={classes.masonryPaginationJumpIcon}
            />
          </div>
        </div>
      </div>
            ...
            <div className={classes.masonryPostKeeper} key={index}>
              <div className={classes.masonryPostImagebox}>
                <div className={classes.masonryPostImageboxInstant}>
                  <FontAwesomeIcon
                    icon={faBolt}
                    className={classes.masonryPostImageboxInstantIcon}
                  />
                  <span>آگهی</span>
                </div>
                ...
                <img
                  ...
                  alt=""
                  className={classes.masonryPostImage}
                />
                <div className={classes.masonryPostLikeBox}>
                  <FontAwesomeIcon
                    icon={faHeart}
                    className={classes.masonryPostLikeIcon}
                  />
                  <span>{runtimeData[post].likeCount || post.likeCount}</span>
                </div>
              </div>
              ...
              <div className={classes.masonryPostSocials}>
                <FontAwesomeIcon
                  icon={faInstagram}
                  className={classes.masonryPostSocialIcon}
                />
                <FontAwesomeIcon
