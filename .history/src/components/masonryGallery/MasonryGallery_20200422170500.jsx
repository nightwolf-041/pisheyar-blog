    ...
    return(
        <div className={classes.MasonryPostKeeper}>
            ...
            <div className={classes.masonryPostSocials}>
                <i className="fab fa-instagram post-social-icon"></i>
                <i className="fab fa-telegram-plane post-social-icon"></i>
                <i className="fab fa-twitter post-social-icon"></i>
                <i className="fab fa-google post-social-icon"></i>
            </div>
        </div>
    )
}
