...
import { faHeart, faBolt, faArrowRight, faSignInAlt } from "@fortawesome/free-solid-svg-icons";
...
const MasonryGallery = () => {
    ...
    return(
        ...
        >
            {posts.slice((currentPage - 1) * 4, currentPage * 4).map((post, index) => (
        ...
        <div className={classes.masonryGalleryPaginationBox}>
            ...
            <div className={classes.masonryPaginationJumpBox}>
                <input type="text" className={classes.paginationGoTo} placeholder="برو به" />
