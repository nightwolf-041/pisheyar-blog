...
const HamburgerMenu = (props) => {
    ...
    return(
        <Scrollbars style={{ width: '300px', height: '100vh', overflowX: 'hidden !important' }} className={!props.show ? classes.hamburgerMenu : classes.hamburgerMenuToggle}>
            {/* <PerfectSrollbars> */}
            {/* <Scrollbars style={{ width: '300px', height: '100vh', overflowX: 'hidden !important' }}> */}
