...
const HamburgerMenu = (props) => {
    ...
    return(
        ...
        <div className={classes.hamburgerMenu}>
            ...
            <div className={[classes.hamburgerMenuItem, classes.hamburgerMenuItemAnimate].join(' ')}>
                <span>خانه</span>
                <FontAwesomeIcon icon={faHome} className={classes.hamburgerMenuItemIcon} />
            </div>
            <div className={[classes.hamburgerMenuItem, classes.hamburgerMenuDropItem, classes.hamburgerMenuItemAnimate].join(' ')}
