      ...
      <header>
        ...
        <nav className="nav">
          <ul className="nav__menu">
            <li className="nav__menu-item">خانه</li>
            <li className="nav__menu-item">
              دسته بندی
              <Submenu />
            </li>
            <li className="nav__menu-item">درباره ما</li>
          </ul>
        </nav>
        {/* </div> */}
...
const Submenu = () => (
  <ul className="nav__submenu">
    <li className="nav__submenu-item ">صنعتی</li>
    <li className="nav__submenu-item ">ورزشی</li>
    <li className="nav__submenu-item ">هنری</li>
  </ul>
);
