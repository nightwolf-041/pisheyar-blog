...
const GridGallery = () => {
    ...
    console.log(khale.childImageSharp.fixed.src);
    const khaleImage = khale.childImageSharp.fixed.src;
        ...
        <div className={classes.gridGallery}>
            ...
            <div className={classes.gridGalleryLeft}>
                <div className={classes.gridGalleryLeftTop}>
                    <Img fixed={khaleImage} alt="" className={classes.gridGalleryLeftTopImage} />
                ...
                <div className={classes.gridGalleryLeftBottom}>
                    <Img fixed={khaleImage} alt="" className={classes.gridGalleryLeftBottomImage} />
                    <div className={classes.gridGalleryOverlay}></div>
