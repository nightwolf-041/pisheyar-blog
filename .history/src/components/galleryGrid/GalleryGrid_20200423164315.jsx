...
const GridGallery = () => {
    ...
    const posts = allRestApiApiPostGetIndexesAnonymous.childImageSharp.fluid;
        ...
        <div className={classes.gridGallery}>
            ...
            <div className={classes.gridGalleryLeft}>
                <div className={classes.gridGalleryLeftTop}>
                    <img src={khalee} alt="" className={classes.gridGalleryLeftTopImage} />
                ...
                <div className={classes.gridGalleryLeftBottom}>
                    <img src={khalee} alt="" className={classes.gridGalleryLeftBottomImage} />
                    <div className={classes.gridGalleryOverlay}></div>
            ...
            <div className={classes.gridGalleryRight}>
                <img src={khalee} alt="" className={classes.gridGalleryRightImg} />
                <div className={classes.gridGalleryOverlay}></div>
