        ...
        <div className={classes.gallery}>
            ...
            <div className={classes.gridGalleryLeft}>
                <div className={classes.gridGalleryLeftTop}>
                    <img src="./img/khale.png" alt="" class="top-gallery-left-top-img" />
                    <div class="top-gallery-overlay top-gallery-overlay-left-top"></div>
                    <div class="top-gallery-left-top-desc">
                        ایشونم که داری میبینی خاله اسکارلت جنگ آور مایه
                    </div>
                </div>
                <div className={classes.gridGalleryLeftTop}></div>
            </div>

            <div className={classes.gridGalleryRight}>
                <Img src={khaleImage} alt="" className={classes.gridGalleryRightImg} />
                <div className={classes.gridGalleryRightOverlay}></div>
