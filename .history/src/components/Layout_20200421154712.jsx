      ...
      <footer className={classes.footer}>
        ...
        <div className={classes.footerMiddleRight}>
          <FontAwesomeIcon
            ...
            className={footerMiddleRightIcon}
          />
          <div className={classes.footerMiddRightTexts}>
            <p className={classes.footerMiddRightText}>
              آزادشهر - خیابان همایونی - نبش
            </p>
            <p className={classes.footerMiddRightText}></p>
          </div>
        </div>
        <div className={classes.footerMiddleLeft}></div>
