    ...
    <>
      ...
      <header className={state ? classes.header : classes.headerToggle}>
        ...
        <div className={classes.headerContainer}>
          ...
          <div
            className={
              state ? classes.headerBottom : classes.headerBottomToggle
            }
          >
            {state ? (
            ...
            <nav className={classes.nav}>
              <ul className={classes.navMenu}>
                <li className={classes.navMenuItem}>
                  <Link to="/" className={classes.navMenuItemLink}>
                    خانه
                  </Link>
                </li>
            ...
            <div
              className={
                state ? classes.navbarIcons : classes.navbarIconsToggle
              }
            >
