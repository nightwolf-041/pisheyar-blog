    ...
    return(
        ...
        <div className={state ? classes.headerSubMenu : classes.headerSubMenuToggle }>
            <div className={classes.headerSubMenuLeft}>
                <div className={[classes.headerSubMenuLeftItem, classes.headerSubMenuLeftItemLeft].join(' ')}>
                ...
                <div className={classes.headerSubMenuLeftItemsDivider}></div>
                ...
                <div className={classes.headerSubMenuLeftItem}></div>
            </div>
            <div className={classes.headerSubMenuRight}></div>
        </div>
