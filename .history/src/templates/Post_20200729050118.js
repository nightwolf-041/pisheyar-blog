    ...
    return (
        <Layout singlePostHeader={true}>
            ...
            <div className="single-post-banner">
                ...
                <h1 className="single-post-title">{post.abstract}</h1>
                <div className="single-post-top-date">
                    {post.modifiedDate}
                </div>
            </div>
            ...
            <div className="single-post-main">
                ...
                <div className="single-post-main-center">
                    ...
                    <div className="single-post-main-buttons-box">
                        {previous !== null && previous.slug !== null ?
                            <Link to={`/${previous.slug}`} className="single-post-main-prev-button">
                                پست قبلی
                            </Link>
                            :
                ...
                <PostRightside postCategory={post.category.title} />
            </div>
...
export const pageQuery = graphql`
	query Posts($slug: String!) {
		allRestApiPostGetAllAnonymous(filter: {posts: {elemMatch: {slug: {eq: $slug}}}}) {
            edges {
                node {
                  posts {
                    title
