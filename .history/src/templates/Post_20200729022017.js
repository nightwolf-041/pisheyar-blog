...
const PostTemplate = (props) => {
    ...
    const {title, abstract, description, userFullName} = fPost[0]
            ...
            <div className="single-post-main">
                ...
                <div className="single-post-main-center">
                    ...
                    <div className="single-post-main-buttons-box">
                        <Link to={`/${previous.slug}`} className="single-post-main-prev-button">پست قبلی</م>
                        <button className="single-post-main-next-button">پست بعدی</button>
                    </div>
                </div>
                <PostRightside />
            </div>
